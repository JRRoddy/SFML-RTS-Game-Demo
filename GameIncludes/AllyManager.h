...
public:
	...
	void initAllyPools(AllyFactionIds allyFactionId, std::vector<AllyInitialiser>& m_alliesToInit, SpriteGenerator * spriteGenerator);
...
private:
	...
	std::map<AllyFactionIds, AllyObjectPool> m_areaPools;
